...
Route::get('/catering',[PortalController::class,'catering'])->name('catering');
        ...
        Route::prefix('menu')
         ...
         Route::prefix('paket')
          ...
          ->group(function(){
             ...
             Route::put('/',[PaketController::class,'update'])->name('update');
             Route::delete('/',[PaketController::class,'destroy'])->name('destroy');
 
             Route::post('/fetch',[PaketController::class,'fetch'])->name('fetch');
